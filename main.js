...
if (pinAnswer.pin === myPin) {
    console.log(chalk.blueBright("Your pin code is correct!!! Login successfully...."));
    ...
    if (operationAns.operation === "withdraw") {
        ...
        console.log(chalk.bgCyanBright(`your remaining account balance is ${myBalance}`));
    }
        ...
        if (myBalance -= cash.fastcash)
            console.log(chalk.cyanBright(`Your remaining Account Balance is ${myBalance}`));
    }
}
else {
